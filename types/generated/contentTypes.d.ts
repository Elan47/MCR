...
export interface ApiAptusAptus extends Struct.CollectionTypeSchema {
  collectionName: 'aptuses';
  info: {
    description: '';
    displayName: 'Aptus';
    pluralName: 'aptuses';
...
export interface ApiCampaignTypeCampaignType
  extends Struct.CollectionTypeSchema {
...
export interface ApiEquitaEquita extends Struct.CollectionTypeSchema {
  collectionName: 'equitas';
  info: {
    description: '';
    displayName: 'Equitas';
    pluralName: 'equitas';
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    access: Schema.Attribute.Relation<'oneToMany', 'api::client.client'>;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::social-type.social-type': ApiSocialTypeSocialType;
